...
bool MyScene::tetrominoHitsGround()
{
...
int32_t MyScene::tetrominoWidth()
{
    int maxX = 0;
    const Tetromino & t = tetrominos[currTetrominoIdx][currTetrominoDir];
    for (auto b: t) {
...
int32_t MyScene::calcScore(int32_t removedRows)
{
